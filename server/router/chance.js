...
router.post('/getChanceList', (req, res) => {
  let params = req.body
  let where = `where c.status in ('未推进', '已推进', '报备待审批', '报备驳回')`
  // 权限筛选
